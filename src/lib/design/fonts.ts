 ...
 *
 * صارت واجهة الموقع على «خط ثمانية» وهو مستضاف عندنا في public لا
 * على Google، وتعريفه في globals.css عبر @font-face. فهذه القائمة
 * فارغة عمداً: كل ما فيها يُطلب من Google، وطلبُ خطٍّ لا نستعمله
 * تأخيرٌ في أول رسم بلا مقابل.
 *
 * وتُترك القائمة قائمةً لا تُحذف: googleFontsHref يبني منها ومن
 * FONTS معاً، وإعادةُ خطِّ واجهةٍ من Google يوماً ما تصير سطراً هنا.
 *
 * ملاحظة: IBM Plex Sans Arabic ما زال يُحمَّل — لكن بوصفه أحد خطوط
 * الدعوات في FONTS، لا بوصفه خط واجهة.
 */
