...
-- المناسبة: «كل مدعو يدخل بباركوده… وأنت تعرف مين حضر لحظة بلحظة».
...
update public.site_content
   set value = '"كل مدعو يدخل بباركوده… وأنت تعرف مين حضر لحظة بلحظة"'::jsonb
 where key = 'home.hero.title';

update public.site_content
   set value = '"ارفع دعوتك الحالية بأي تصميم، ونولّد باركود دخول فريد لكل مدعو باسمه. على الباب تمسحه من جوالك وبس — بدون طابعة، بدون تطبيق، بدون فوضى."'::jsonb
 where key = 'home.hero.subtitle';
